...
if __name__ == '__main__':
    ...
    while True:
        ...
        if choice == 's' or choice == 'S':
            ...
            try:
                [print(each.screen_name) for each in api.GetFollowers(screen_name = name)]
            ...
            try:
                [print(each.screen_name) for each in api.GetFollowers(name = name)]
            except twitter.error.TwitterError:
                print("Rate limit exceeded")
                break
            ...
            try:
                [print(each.screen_name) for each in api.GetFollowers(description = description)]
            except twitter.error.TwitterError:
                print("Rate limit exceeded")
                break
